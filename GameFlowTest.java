...
public class GameFlowTest{
  ...
  @Test
  /*** 
  * this test is to assure random cards are valid.
  */
  ...
  /*** 
  * this test is to assure any new round has 7 cards
  */   
  @Test
  ...
  /*** 
  * this test is to assure drawing a card must adds to players hand as one. 
  */   
  @Test
  ...
  /*** 
  * this test is to assure game reverse directions correctly.  
  */   
  @Test 
  ...
  /*** 
  * this test is for skip player to assure correct player is skipped.
  */   
   @Test 
  ...
  /*** 
  * this test is to assure wild cards colour change depending on user. 
  */   
   @Test 
  ...
  /*** 
  * this test is to assure that when you draw cards that two cards are given for wild cards and next player is skipped
  */   
   @Test 
  ...
  /*** 
  * this test is to assure game sum correctly.  
  */   
  @Test 
